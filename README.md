...
#### written by [Dr. Nancy Tinkham](http://elvis.rowan.edu/~nlt/)

## About
The objective is to complete this Semester Homework problem in the multiple languages: [Scheme](medical_test_scheme), [Ada](medical_test_ada.adb), [Prolog](), and my [Language-Learning](https://github.com/anttesoriero/Language-Learning-Python)  assigned language, [Python]().

This assignment is for Programming Languages F19 at Rowan University.
